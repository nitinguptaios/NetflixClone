...
//  NetflixClone
//
//  Created by Nitin Gupta on 21/04/22.
//
...
class HomeViewController: UIViewController {
    ...
    private func configureNavBar(){
        ...
        let play = UIBarButtonItem(image: UIImage(systemName: "play.rectangle"), style: .done, target: self, action: #selector(playButtonTapped))
    ...
    @objc func playButtonTapped() {
        ...
        //NotificationCenter.default.post(name: Notification.Name(UIScreen.didConnectNotification.rawValue), object: nil)
    }
